  ...
  return <header className="border-b border-border bg-card">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="icon" onClick={handlePreviousWeek} className="h-9 w-9 border-border hover:bg-accent">
          ...
          <Button variant="outline" size="icon" onClick={handleNextWeek} className="h-9 w-9 border-border hover:bg-accent">
            <ChevronRight className="h-4 w-4" />
          </Button>

          <Button variant="outline" size="icon" onClick={() => setDatePickerOpen(true)} className="h-9 w-9 border-border hover:bg-accent ml-2" title="Jump to date">
      ...
      <DatePickerModal open={datePickerOpen} onClose={() => setDatePickerOpen(false)} onDateSelect={handleDateSelect} title="Jump to Date" selectedDate={currentWeekStart} />
